...
public class DataGenerator implements Runnable {
    ...
    public void run() {
        ...
        // Print the limits.
        System.out.println("[Worker " + workerId + "] Min Latitude: " + minLatitudeLimit + ", Max Latitude: " + maxLatitudeLimit + "\n"
        ...
        System.out.println("[Worker " + workerId + "] Latitude: " + coordinate.getLatitude() + ", Longitude: " + coordinate.getLongitude());
    }
}
